...
def test_predefined_connection_set():
    ...
    assert classify(0x185, False) == ("TPDO1 n5", "PDO")
    assert classify(0x205, False) == ("RPDO1 n5", "PDO")
    assert classify(0x485, False) == ("TPDO4 n5", "PDO")
    assert classify(0x585, False) == ("SDO-T n5", "SDO")
    assert classify(0x605, False) == ("SDO-R n5", "SDO")
    assert classify(0x705, False) == ("HB n5", "Heartbeat")
    assert classify(0x77F, False) == ("HB n127", "Heartbeat")
