...
pycangui opens with four panes: the **CAN Trace** with **CAN Transmit** under it
...
[**Signals and Plot**](signals.md), [**CAN Transmit**](transmit.md) or
[**ASCII Log**](ascii-log.md) -- the panes pycangui comes with that you can have more than one
